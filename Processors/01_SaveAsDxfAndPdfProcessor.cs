namespace SolidEdgeAdd_In.Processors
{
    public class SaveAsDxfAndPdfProcessor
    {
        ...
        public bool Initialize()
        {
            ...
            if (string.IsNullOrEmpty(_draftPath)) { MessageBox.Show("Save draft first to export DXF and PDF formats."); return false; }

            try { _draft.Save(); } catch { MessageBox.Show("Cannot update draft."); return false; }
