namespace SolidEdgeAdd_In.Utils
{
    public static class Constants
    {
        ...
        public static class Styles
        {
            ...
            public const string Steelmaking = "Hutnicze";
            public const string Commercial = "Handlowe";
            public const string Standard = "Normalia";
            public const string SheetMetal = "Blacha";
        }
    }
}
