namespace SolidEdgeAdd_In.Utils
{
    ...
    public class Helpers
    {
            ...
            try
            {
                ...
                if (planes != null)
                {
                    for (int i = 1; i <= planes.Count; i++)
                    {
                        ...
                        try { plane = (SeRefPlane)planes.Item(i); plane.Visible = visible; }
                ...
                if (axes != null)
                {
                    ...
                    {
                        SeRefAxis axis = null;
                        try { axis = (SeRefAxis)axes.Item(i); axis.Visible = visible; }
                ...
                if (coords != null)
                {
                    for (int i = 1; i <= coords.Count; i++)
                    {
                        ...
                        try { cs = (SeCoordinateSystem)coords.Item(i); cs.Visible = visible; }
            ...
            try
            {
                ...
                if (planes != null)
                {
                    for (int i = 1; i <= planes.Count; i++)
                    {
                        ...
                        try { plane = (SeAsmRefPlane)planes.Item(i); plane.Visible = visible; }
                        finally { ReleaseCom(ref plane); }
                    }
                }
            }
        ...
        public static int GetCount(Dictionary<string, int> data, string filePath)
        {
